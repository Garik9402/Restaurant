...
window.addEventListener('click', function (event) {
  if (event.target.dataset.action === 'arrow') {
    var _spoiler = event.target.closest('.spoiler');
  }
});
spoilersArrowsNode.forEach(function (elem) {
  elem.addEventListener('click', function (event) {
    spoilersArrowsNode.forEach(function (e) {
      e.classList.remove('spoiler__arrow--js-open-list');
    });
    spoilersArrowsNode.forEach(function (element) {
      if (event.target.dataset.action === 'arrow') {
        var _spoiler2 = event.target.closest('.spoiler');

        _spoiler2.classList.add('spoiler--js-open-list');
      }
...
var dropdownInfo = document.querySelector('.popup-product__info');
window.addEventListener('click', function (event) {
